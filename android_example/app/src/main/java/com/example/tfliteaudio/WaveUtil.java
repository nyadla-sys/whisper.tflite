...
public class WaveUtil {
    ...
    public static void createWaveFile(String wavePath, float[] samples) throws IOException {
        // get audio params
        int sampleRate = SAMPLE_RATE;
        short channels = (short) NO_OF_CHANNELS;
        short bytesPerSample = (short) BYTES_PER_SAMPLE;

        // calculate header values
        int audioSize = samples.length * BYTES_PER_SAMPLE;
        ...
        out.writeShort(reverseShortBytes((short) 3)); // AudioFormat PCM_16 = 1, PCM_FLOAT = 3
