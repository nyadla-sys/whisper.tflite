...
public class Recorder {
    ...
    private void threadFunction() {
        try {
            ...
            // Save only the actual recorded audio in wav file
            byte[] actualData = new byte[totalBytesRead]; buffer30Sec.flip(); buffer30Sec.get(actualData, 0, totalBytesRead); WaveUtil.createWaveFile(mWavFilePath, actualData, sampleRateInHz, channels, bytesPerSample);
